...
select first_name, last_name from customer WHERE first_name IN ('Marion', 'Jamie', 'Tracy', 'Kelly', 'Leslie', 'Willie', 'Jessie', 'Terry') 
...
SELECT first_name, last_name FROM customer 
WHERE first_name LIKE 'jan%';          -- data/values should be case sensitive 

SELECT first_name, last_name FROM customer 
WHERE first_name ILIKE 'jan%';          -- ILIKE - case insensitive like
...
SELECT MAX(amount) FROM payment; -- select amount from payment order by amount desc; 
SELECT MIN(amount) FROM payment; -- select amount from payment order by amount asc
